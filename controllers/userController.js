...
const loadIndex = async (req, res) => {
  try {
    ...
    const  groups=await Group.find({members:loggin._id}).populate('members');
    res.render("index", { users, loggin,groups });
  } catch (error) {
...
const createGroup = async (req, res) => {
  try {
    const group = new Group({
      ...
      avatar:"https://cdn4.iconfinder.com/data/icons/avatar-1-2/100/Avatar-16-512.png"
    })
    await group.save();
    return res.redirect("/");
  } catch (error) {
